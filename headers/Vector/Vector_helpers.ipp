template<typename T>
int Vector<T>::size() const { return this->get_rows(); }

template<typename T>
Vector<T> Vector<T>::zero(int size) { 
...
template<typename T>
Vector<T> Vector<T>::basis(int size, int k) {
...
template<typename T>
Vector<T> Vector<T>::random(int size, T min_val, T max_val) {
...
template<typename T>
Vector<T> Vector<T>::random(int size) {
...
template<typename T>
Vector<T> Vector<T>::random_unit(int size) {
