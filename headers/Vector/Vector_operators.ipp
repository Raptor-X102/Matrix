...
template<typename T>
template<typename U>
Vector<T>::operator Vector<U>() const { return cast_to<U>(); }
...
template<typename T>
T &Vector<T>::operator()(int i) { return Matrix<T>::operator()(i, 0); }

template<typename T>
const T &Vector<T>::operator()(int i) const { return Matrix<T>::operator()(i, 0); }

template<typename T>
T &Vector<T>::operator[](int i) { return (*this)(i); }

template<typename T>
const T &Vector<T>::operator[](int i) const { return (*this)(i); }
